...
export default function NotificationsPage() {
  ...
  const saveNotificationToHistory = (message: string, recipients: number, phoneNumbers: number) => {
  ...
  const handleSendNotification = async () => {
    ...
    try {
      ...
      // Save to history
      saveNotificationToHistory(message, selectedStudents.length, phoneNumbers.length)
